        ...
        public static async Task SeedSampleDataAsync(ApplicationDbContext context)
        {
            ...
            if (!context.MonopolyFields.Any())
            {
                context.MonopolyFields.AddRange(
                        ...
                        new PropertyField
                        {
                            Name = "Laboratorium 303(MS)",
                            Color = PropertyColor.Green,
                            Price = 200,
                            Mortage = 120,
                            EstatePrice = 150,
                            RentCosts = new List<int> { 20, 100, 300, 750, 925, 1100 },
                            Purschased = false,
                        ...
                        new PropertyField
                        {
                            Name = "Sala Wykładowa 404(CNT)",
                            Color = PropertyColor.Yellow,
                            Price = 150,
                            Mortage = 70,
                            EstatePrice = 100,
                            RentCosts = new List<int> { 10, 50, 150, 450, 625, 750 },
                            Purschased = false,
                            PropertyFieldInfo = new PropertyFieldInfo
                            {
                                EstatesBought = 0,
                        ...
                        new PropertyField
                        {
                            Name = "Laboratorium Budo",
                            Color = PropertyColor.Blue,
                            Price = 300,
                            Mortage = 150,
                            EstatePrice = 175,
                            RentCosts = new List<int> { 80, 140, 300, 600, 1000, 1500 },
                            Purschased = false,
                            PropertyFieldInfo = new PropertyFieldInfo
                            {
                                EstatesBought = 0,
